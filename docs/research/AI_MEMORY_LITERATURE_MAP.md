...
| BENCH-004 | [MemoryAgentBench](https://openreview.net/forum?id=DT7JyQC3MR), ICLR 2026 | [official code](https://github.com/HUST-AI-HYZ/MemoryAgentBench), MIT, `fe1735de8cf8b9908e1e3d3b5612afc815698062`; license SHA-256 `94d735aad92355b4880c969fa309e824eb12fdeeb271ae51cf6143866cf78cf7` | accurate retrieval, test-time learning, long-range understanding, and a revision-sensitive fourth competency | [arXiv v1](https://arxiv.org/abs/2507.05257v1) (2025-07-07) called the fourth competency “conflict resolution”; [v4](https://arxiv.org/abs/2507.05257v4) (2026-06-28) calls it “selective forgetting,” while the inspected repository still labels `fact_mh`/`fact_sh` Conflict Resolution and maps their reported Accuracy to `substring_exact_match` while calculating other QA metrics. Pin paper and code revisions separately; this QA label/metric is not evidence of physical erasure, reader suppression, or restart persistence |
