...
| BENCH-004 | [MemoryAgentBench](https://openreview.net/forum?id=DT7JyQC3MR), ICLR 2026 | [official code](https://github.com/HUST-AI-HYZ/MemoryAgentBench), MIT, `fe1735de8cf8b9908e1e3d3b5612afc815698062` | accurate retrieval, test-time learning, long-range understanding, and conflict resolution | strongest broad ability matrix; run individual competencies before a composite score. Earlier paper/workshop descriptions used “selective forgetting,” so revision and task-to-metric mapping must be pinned |
